...
<head>
    ...
    <link rel="canonical" href="https://www.company-website.com/" />
    ...
    <header id="header">
        ...
        <nav class="navbar navbar-expand top">
            <div class="container header">
                ...
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a href="#" class="nav-link pl-0"><i class="fas fa-clock mr-2"></i>Working Hours : MON
                            -
                            FRI - 8:00 AM - 05:00 PM</a>
                    </li>
                </ul>
                <!-- Nav holder -->
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a href="#" class="nav-link"><i
                                class="fas fa-envelope mr-2"></i>info@company.com</a>
                    </li>
                </ul>
                <!-- Navbar Icons -->
                ...
                <li class="nav-item social pl-5" style="list-style: none">
                    <a href="/tr" target="_blank"><img src="assets/images/tr.png" width="32"
                            height="32"></a>
                </li>
                <li class="nav-item social pl-2" style="list-style: none">
                    <a href="/en" target="_blank"><img src="assets/images/en.png" width="32"
                            height="32"></a>
                </li>
            </div>
        </nav>
        ...
        <nav class="navbar navbar-expand navbar-fixed sub">
            <div class="container header">
                ...
                <a class="navbar-brand" href="/{{ $lang }}">
                    <img src="assets/images/logo.png" alt="COMPANY WEBSITE" width="125" height="225"
                        style="width: 225px!important;height: 125px!important;">
                </a>
                <!-- Nav holder -->
                <div class="ml-auto"></div>
                <!-- Navbar Items -->
                <ul class="navbar-nav items">
                    ...
                    <li class="nav-item">
                        <a href="#header" class="smooth-anchor nav-link">HOMEPAGE</a>
                    </li>
                    <li class="nav-item">
                        <a href="#video" class="smooth-anchor nav-link">ABOUT US</a>
                    </li>
                    <li class="nav-item">
                        <a href="#services" class="smooth-anchor nav-link">SERVICES</a>
                    </li>
                    <li class="nav-item">
                        <a href="#team" class="smooth-anchor nav-link">ORGANIZATIONAL STRUCTURE</a>
                    </li>
                </ul>
                <!-- Navbar Toggle -->
                            ...
                            <div class="col-12 d-flex justify-content-start inner">
                                <div class="left text-left">
                                    ...
                                    <p data-aos="zoom-in" data-aos-delay="2400" class="description">
                                        {{ $slider->en_description }}
                                    </p>
                                    <!-- Action -->
                                    <div data-aos="fade-up" data-aos-delay="2800" class="buttons">
                                        <div class="d-sm-inline-flex">
                                            <a href="#contact" class="smooth-anchor mt-4 btn primary-button">CONTACT US</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-12 col-lg-8 align-self-top text-center text-md-left text">
                    <div class="row intro">
                        <div class="col-12 p-0">
                            <h2><span class="featured"><span>Team</span></span> members</h2>
                            <p>Ethics and integrity are the foundations on which our professionals build their careers.<br>These are the foundations that become everyday attitudes.</p>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-8 pr-md-5 align-self-center text">
                    <div class="row intro">
                        <div class="col-12 p-0">
                            <span class="pre-title m-0">Send Message</span>
                            <h2>Contact <span class="featured"><span>us</span></span></h2>
                            ...
                            <form action="php/form.php" id="nexgen-simple-form" class="nexgen-simple-form">
                                ...
                                <div class="row form-group-margin">
                                    ...
                                    <div class="col-12 input-group m-0 p-2">
                                        <a class="btn primary-button">SUBMIT</a>
                                    </div>
                                </div>
                            </form>
                        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-lg-4 footer-left">
                        <!-- Navbar Brand-->
                        <a class="navbar-brand" href="/{{ $lang }}">
                            <img src="assets/images/logo.png" alt="COMPANY WEBSITE" width="125"
                                height="225" style="width: 225px!important;height: 125px!important;">
                        </a>
                        <p></p>
                        <ul class="navbar-nav">
                            <li class="nav-item">
                    ...
                    <div class="col-12 col-lg-8 p-0 footer-right">
                        <div class="row items">
                            <div class="col-12 col-lg-6 item">
                                <div class="card">
                                    <h4>SERVICES</h4>
                                    <a href="#proje"><i class="icon-arrow-right"></i>Project</a>
                                    <a href="#egitim"><i class="icon-arrow-right"></i>Education</a>
                                    <a href="#yonetim"><i class="icon-arrow-right"></i>Management</a>
                                    <a href="#denetim"><i class="icon-arrow-right"></i>Audit</a>
                                    <a href="#arge"><i class="icon-arrow-right"></i>R&D</a>
                                    <a href="#organizasyon"><i class="icon-arrow-right"></i>Organization</a>
                                </div>
                            </div>
                            <div class="col-12 col-lg-6 item d-none">
                                <div class="card">
                                    <h4>FAYDALI LİNKLER</h4>
                                    <a href="https://www.msb.gov.tr/" target="_blank"><i
                                            class="icon-arrow-right"></i>Milli Savunma Bakanlığı</a>
                                    <a href="https://www.icisleri.gov.tr/" target="_blank"><i
                                            class="icon-arrow-right"></i>İçişleri Bakanlığı</a>
                                    <a href="https://www.enerji.gov.tr/" target="_blank"><i
                                            class="icon-arrow-right"></i>Enerji ve Tabii Kaynaklar Bakanlığı</a>
                                    <a href="https://www.ormansu.gov.tr/" target="_blank"><i
                                            class="icon-arrow-right"></i>T.C. Orman ve Su İşleri Bakanlığı</a>
                                    <a href="https://www.ssm.gov.tr/" target="_blank"><i
                                            class="icon-arrow-right"></i>Savunma Sanayii Müsteşarlığı</a>
                                    <a href="https://www.saglik.gov.tr/" target="_blank"><i
                                            class="icon-arrow-right"></i>Sağlık Bakanlığı</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-slideout" role="document">
            <div class="modal-content full">
                ...
                <div class="modal-body p-0">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3060.3019678651144!2d32.77818011531629!3d39.91225807942689!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14d3489ea66214c9%3A0xb75255bf1b7977ff!2sNEP%20OFFICE!5e0!3m2!1str!2str!4v1665324142533!5m2!1str!2str"
