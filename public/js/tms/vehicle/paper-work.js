$(function () {
    ...
    const editPaperwork = function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                paperModal.find('input[name="vehicle_id"]').val(data.paper.vehicle_id);
    ...
    const updatePaperwork = function () {
        ...
        var vehicleId = paperModal.find('input[name="vehicle_id"]').val();
    ...
    const addPaperwork = function (vehicleId) {
